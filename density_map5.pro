 ...
 while yy lt maxy do begin
  ...
  IF INSIDEBOX[0] ne -1 then begin 
   ...
   IF keyword_set(z_axe) then begin
    IF Z_TYPE eq 'sum' THEN Value[XC,YC]=total(weight[INSIDEBOX])
